...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full h-[70px] z-50 bg-white/95 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-4 md:px-8 shadow-sm transition-all">
      ...
      <div className="flex items-center gap-4">
        {currentUser ? (
          ...
          >
            ...
            {popupDisplay && (
              <div
                className="absolute top-[60px] right-0 w-[280px] bg-white rounded-xl shadow-2xl border border-gray-100 p-4 flex flex-col gap-2 animate-in fade-in zoom-in-95 duration-200 origin-top-right"
      ...
      {mobileMenuOpen && (
        <div className="absolute top-[70px] left-0 w-full bg-white border-b border-gray-200 shadow-xl flex flex-col p-4 md:hidden animate-in slide-in-from-top-5 duration-200">
          <Link
